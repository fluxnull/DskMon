# Example script for using the DskMonPS5 DLL.
# This script should be run in Windows PowerShell (PS5).

# Get the directory of the script.
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path

# The DLLs are expected to be in a 'dist' directory relative to the script.
$DllPath = Join-Path $ScriptDir "..\dist\DskMon_ps5_x64.dll" # Assuming x64
